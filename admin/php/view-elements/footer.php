...
<!--        
            <h3>Forhåndsvisning</h3>
            <IFRAME id="iFrame" name="iFrame" SRC="view-elements/menu.html" WIDTH=320 HEIGHT=480 style="border-radius: 5px;">
                If you can see this, your browser doesn't 
                understand IFRAME.  However, we'll still 
                <A HREF="view-elements/menu.html">link</A> 
                you to the file.
            </IFRAME> 
            <p><p>
            <input type="button" class="btn" value="Oppdater" onClick="javascript:updateFrame('view-elements/menu.html');" style="float:">-->
